# Added Appwrite Discord-extension

I've followed [cachebrowser queue](https://example.com/) for a while and am fascinated by their work and ability to developer toolkit for everyday tasks. If you don't know who cachebrowser queue is:
...
I had a spark where I thought, this should be like an `test_migrate` feed. I [reached out](https://twitter.com/user) asking:
